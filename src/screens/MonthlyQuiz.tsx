...
export default function MonthlyQuiz() {
  ...
  const LangToggle = (
    <div className="inline-flex items-center rounded-full border border-[rgb(var(--rule)/0.12)] bg-cream p-0.5">
  ...
  if (phase === 'intro') {
    ...
    return (
      <div className="space-y-8">
        {/* Header */}
        <header className="flex flex-wrap items-start justify-between gap-6 pb-6 border-b border-[rgb(var(--rule)/0.08)]">
          <div className="max-w-[560px]">
            ...
            <div className="flex flex-wrap gap-2 mt-5">
              {rules.map((r) => (
                <span
                  key={r.label}
                  className="inline-flex items-center gap-1.5 text-xs font-medium text-ink-secondary bg-cream border border-[rgb(var(--rule)/0.1)] rounded-full px-3 py-1.5"
                >
        ...
        <button
          ...
          className="group w-full text-left bg-cream rounded-2xl border border-[rgb(var(--rule)/0.1)] shadow-card hover:shadow-elevated hover:-translate-y-0.5 transition-all overflow-hidden"
        >
        ...
        {/* Leaderboard */}
        <section className="bg-cream rounded-2xl border border-[rgb(var(--rule)/0.1)] p-6 shadow-card">
  ...
  if (phase === 'rules') {
    ...
    return (
      <div className="max-w-[640px] mx-auto space-y-6">
        <div className="bg-cream rounded-2xl border border-[rgb(var(--rule)/0.1)] shadow-card overflow-hidden">
          <div className="h-1 w-full bg-gradient-to-r from-[#5f8a6b] via-[#b98a3e] to-[#a8503f]" />
          <div className="p-7 sm:p-8">
            ...
            <div className="mt-6 space-y-3">
              {ruleItems.map((r) => (
                <div
                  key={r.title}
                  className="flex items-start gap-3 rounded-xl bg-parchment/60 border border-[rgb(var(--rule)/0.08)] px-4 py-3"
                >
                  <span className="w-8 h-8 rounded-lg bg-[rgb(var(--rule)/0.06)] flex items-center justify-center flex-shrink-0">
            ...
            <div className="flex items-center justify-between gap-4 mt-7 pt-6 border-t border-[rgb(var(--rule)/0.08)]">
              <div>
              ...
              <div className="flex items-center gap-3">
                <button
                  ...
                  className="inline-flex items-center gap-2 bg-transparent border border-[rgb(var(--rule)/0.15)] text-ink-secondary px-5 py-3 rounded-full text-sm font-semibold hover:bg-[rgb(var(--rule)/0.04)] transition-colors"
                >
                  {t.back}
                </button>
                <button
      ...
      <div className="max-w-[720px] mx-auto">
                ...
                return (
                  <div
                    ...
                    className={cn(
                      ...
                      state === 'todo' && 'bg-[rgb(var(--rule)/0.1)]',
                    )}
                  />
                )
              })}
        ...
        <AnimatePresence mode="wait">
          <motion.div
            ...
            className="bg-cream rounded-2xl border border-[rgb(var(--rule)/0.1)] p-6 sm:p-8 shadow-card"
          >
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      !submitted && !isSelected &&
                        'border-[rgb(var(--rule)/0.12)] hover:border-ink-primary/50 hover:bg-[rgb(var(--rule)/0.02)] cursor-pointer',
                      ...
                      submitted && !showRight && !showWrong && 'border-[rgb(var(--rule)/0.08)] opacity-55',
                    )}
                  >
                    <span
                      className={cn(
                        ...
                        !showRight && !showWrong && !showPending && 'bg-[rgb(var(--rule)/0.07)] text-ink-secondary',
                      )}
                    >
                      {showRight ? (
              ...
              <div className="flex items-center justify-between mt-6">
                ...
                <button
                  ...
                  className={cn(
                    ...
                    selected === null
                      ? 'bg-[rgb(var(--rule)/0.08)] text-ink-tertiary cursor-not-allowed'
  ...
  return (
    <div className="max-w-[720px] mx-auto space-y-6">
      <motion.div
        ...
        className="bg-cream rounded-2xl border border-[rgb(var(--rule)/0.1)] shadow-card overflow-hidden"
      >
        <div className="h-1 w-full bg-gradient-to-r from-[#5f8a6b] via-[#b98a3e] to-[#a8503f]" />
        <div className="p-8 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-2 mt-6">
            ...
            {timedOutCount > 0 && (
              <span className="inline-flex items-center gap-1.5 text-xs font-medium px-3 py-1.5 rounded-full bg-[rgb(var(--rule)/0.06)] text-ink-secondary">
              ...
              .map((lvl) => {
                ...
                return (
                  <div key={lvl}>
                    ...
                    <div className="h-2 rounded-full bg-[rgb(var(--rule)/0.08)] overflow-hidden">
                      <div
          ...
          <div className="flex flex-wrap justify-center gap-3 mt-8">
            ...
            <button
              onClick={() => setPhase('intro')}
              className="inline-flex items-center gap-2 bg-transparent border border-[rgb(var(--rule)/0.15)] text-ink-secondary px-6 py-3 rounded-full text-sm font-semibold hover:bg-[rgb(var(--rule)/0.04)] transition-colors"
            >
              {t.backToOverview}
            </button>
          </div>
      ...
      {/* Answer review */}
      <div className="bg-cream rounded-2xl border border-[rgb(var(--rule)/0.1)] p-6 shadow-card">
        <h4 className="text-base font-semibold text-ink-primary mb-4">{t.review}</h4>
        <div className="divide-y divide-[rgb(var(--rule)/0.06)]">
          {questions.map((q, i) => {
            const a = answers[i]
            const ok = a?.correct
...
function StatTile({
  ...
  return (
    <div className="bg-cream rounded-xl border border-[rgb(var(--rule)/0.1)] px-4 py-3 text-center shadow-card min-w-[92px]">
