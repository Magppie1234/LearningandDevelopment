          ...
          <div className="space-y-1.5">
            {unmapped.map((m) => {
              ...
              return (
                <div
                  key={m.id}
                  className="flex flex-wrap items-baseline gap-x-3 gap-y-0.5 text-xs border-b border-[rgb(var(--rule)/0.06)] last:border-0 pb-1.5 last:pb-0"
                >
              ...
              <tbody>
                {overdue.slice(0, 12).map((r) => (
                  <tr
                    ...
                    className="border-t border-[rgb(var(--rule)/0.06)]"
                  >
      ...
      <section className={cn(CARD, 'p-5')}>
        ...
        <div className="grid md:grid-cols-2 gap-4">
          {intakes.map(({ intake, mix, members }) => (
            <div key={intake} className="rounded-xl bg-[rgb(var(--rule)/0.03)] p-4">
