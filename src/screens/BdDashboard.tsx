    ...
    <div className="max-w-[1000px] mx-auto space-y-8">
      ...
      {nextModule ? (
        <Link
          ...
          className="group flex items-center justify-between gap-4 rounded-2xl border-[0.5px] border-[rgb(var(--rule)/0.14)] bg-cream px-6 py-5 shadow-card hover:shadow-elevated hover:-translate-y-0.5 transition-all duration-300"
        >
      ...
      <section>
        ...
        <div className="rounded-2xl border-[0.5px] border-[rgb(var(--rule)/0.14)] bg-cream p-6 space-y-4 shadow-card">
      ...
      <section>
        ...
        {diagnostic.status === 'completed' ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
              {diagnostic.results.map((r) => {
                ...
                return (
                  <div
                    key={r.moduleId}
                    className="flex items-center gap-3 rounded-[12px] border-[0.5px] border-[rgb(var(--rule)/0.14)] bg-cream px-4 py-3"
                  >
                    {r.correct ? (
          ...
          <div className="rounded-2xl border-[0.5px] border-[rgb(var(--rule)/0.14)] bg-cream px-6 py-5 flex flex-wrap items-center justify-between gap-4 shadow-card">
      ...
      <section>
        ...
        <div className="rounded-2xl border-[0.5px] border-[rgb(var(--rule)/0.14)] bg-cream overflow-hidden shadow-card">
          {BD_MODULES.map((m, i) => {
            const r = results[m.id]
            const status: StatusKey = r?.passed ? 'passed' : r?.viewed ? 'inProgress' : 'notStarted'
            ...
            return (
              <Link
                ...
                className={cn(
                  'group flex items-center gap-4 px-5 py-3.5 hover:bg-[rgb(var(--rule)/0.03)] transition-colors',
                  i > 0 && 'border-t-[0.5px] border-[rgb(var(--rule)/0.08)]',
                )}
              >
                <StatusIcon
                  size={18}
      ...
      <section>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          ...
          />
          <div className="rounded-[12px] border-[0.5px] border-[rgb(var(--rule)/0.14)] bg-cream p-4 shadow-card">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          {[
            ...
            <Link
              key={l.href}
              href={l.href}
              className="group rounded-[12px] border-[0.5px] border-[rgb(var(--rule)/0.14)] bg-cream p-4 shadow-card hover:shadow-elevated hover:-translate-y-0.5 transition-all duration-300"
            >
