        ...
        return (
          <motion.section
            ...
            className={cn(
              ...
              locked ? 'border-[rgb(var(--rule)/0.06)] opacity-60' : 'border-[rgb(var(--rule)/0.08)]',
            )}
          >
            <header className="flex items-center justify-between px-5 py-4 border-b border-[rgb(var(--rule)/0.06)]">
              <div>
                  ...
                  <li key={t.id}>
                    <button
                      ...
                      className={cn(
                        ...
                        t.isCheckpoint && 'bg-[rgb(var(--rule)/0.025)]',
                      )}
                    >
                      {isDone ? (
