    ...
    <div className="max-w-[1200px] mx-auto space-y-6">
      ...
      >
        ...
        <div className="relative z-10 p-10">
          ...
          >
            <span className="text-stone-ivory/80 text-[13px] font-medium">
              Current Track:
            </span>
            <div
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 items-stretch">
          ...
          >
            ...
            <div className="mt-4 bg-stone-espresso rounded-xl p-5 text-center">
              ...
              <div className="mt-4 space-y-1.5 text-left">
                {(Object.keys(demoPrsPoints) as PrsComponent[]).map((key) => (
                  <div key={key} className="flex items-center justify-between gap-3">
                    <span className="text-[11px] text-stone-ivory/80">
              ...
              <p className="text-[11px] text-stone-ivory/80 mt-3">
            ...
            >
              ...
              <div className="flex flex-wrap gap-1.5 mt-3">
                {path.skills.map((skill) => (
                  <span
                    key={skill}
                    className="text-[11px] font-medium bg-[rgb(var(--rule)/0.06)] text-ink-secondary px-2.5 py-1 rounded-full"
                  >
                    {skill}
                  </span>
                ))}
                  ...
                  <button
                    className={cn(
                      ...
                      action.btnStyle === 'ghost' &&
                        'text-ink-secondary hover:bg-[rgb(var(--rule)/0.06)]'
                    )}
                  >
                    {action.btn}
                  </button>
