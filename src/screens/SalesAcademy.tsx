...
import { Block } from '@/screens/BdAcademy'
        ...
        {SALES_MODULES.map((m) => {
          ...
          return (
            <button
              ...
              className="w-full text-left rounded-[12px] border-[0.5px] border-[rgb(var(--rule)/0.14)] bg-cream p-4 hover:shadow-card transition-shadow flex items-center gap-3"
            >
              {r?.passed ? (
