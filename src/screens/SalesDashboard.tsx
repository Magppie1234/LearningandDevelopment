  ...
  return (
    <div className="max-w-[1000px] mx-auto space-y-8">
            ...
            return (
              ...
              >
                ...
                <span className="hidden md:flex items-center gap-2 w-28 shrink-0">
                  <span className="flex-1 h-1.5 rounded-full bg-[rgb(var(--rule)/0.07)] overflow-hidden">
                    <span
      ...
      <section>
        ...
        <div className="mt-3 rounded-2xl border-[0.5px] border-[rgb(var(--rule)/0.14)] bg-cream p-5 shadow-card">
          ...
          <div className="space-y-2">
            {academy.leaderboard.slice(0, 3).map((entry) => (
              <div key={entry.rank} className="flex items-center gap-3">
                ...
                <span className="w-24 h-1.5 rounded-full bg-[rgb(var(--rule)/0.07)] overflow-hidden">
                  <span
                    className="block h-full rounded-full"
