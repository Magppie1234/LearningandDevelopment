          ...
          <div>
            ...
            <div className="flex flex-wrap gap-1.5">
              {step.disp.map((d) => (
                <span
                  key={d.label}
                  className="text-xs px-2 py-0.5 rounded-full bg-[rgb(var(--rule)/0.06)] text-ink-secondary"
                  title={d.desc}
                >
                  {d.label}
                </span>
      ...
      <div className="flex flex-col sm:flex-row gap-3 sm:items-center">
        ...
        <div className="relative flex-1 sm:max-w-xs sm:ml-auto">
          ...
          <input
            ...
            className="w-full pl-9 pr-3 py-2 rounded-full bg-[rgb(var(--rule)/0.05)] text-sm text-ink-primary placeholder:text-ink-tertiary focus:outline-none focus:ring-2 focus:ring-accent-copper/40"
          />
        </div>
      </div>
          ...
          <div className="space-y-2">
            {group.stages.map((s) => {
              ...
              return (
                <div
                  key={s.index}
                  className="rounded-2xl bg-white/70 dark:bg-white/5 border border-[rgb(var(--rule)/0.08)] overflow-hidden"
                >
                  <button
                  ...
                  <AnimatePresence initial={false}>
                    {open && (
                      ...
                      >
                        <div className="px-4 pb-4 border-t border-[rgb(var(--rule)/0.06)]">
