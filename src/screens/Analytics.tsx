...
function KPICard({ data, index }: { data: (typeof kpiData)[0]; index: number }) {
  ...
  return (
    <motion.div
      ...
      initial="hidden"
      animate="visible"
      className="bg-cream rounded-[12px] p-4 border-[0.5px] border-[rgb(var(--rule)/0.14)] dark:border-[rgba(255,255,255,0.1)] flex flex-col justify-between transition-shadow hover:shadow-card"
    >
  ...
  return (
    <div className="space-y-8">
      ...
      <motion.div
        ...
        className="pb-4 border-b border-[rgb(var(--rule)/0.08)] flex items-start justify-between"
      >
        <div>
        ...
        <div className="flex items-center gap-3">
          <button className="flex items-center gap-2 px-4 py-2.5 bg-card rounded-lg text-sm text-ink-primary border border-[rgb(var(--rule)/0.08)] hover:bg-secondary transition-colors">
            <Calendar size={16} />
            Oct 1 – Oct 31, 2024
            <ChevronDown size={14} />
          </button>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[55%_45%] gap-5">
        ...
        <motion.div
          ...
          className="bg-card rounded-2xl p-6 border border-[rgb(var(--rule)/0.08)]"
          style={{ boxShadow: '0 4px 20px rgb(var(--rule)/0.08)' }}
        >
          <div className="mb-4">
          ...
          <ResponsiveContainer width="100%" height={420}>
            ...
            >
              <CartesianGrid strokeDasharray="3 3" stroke="rgb(var(--rule)/0.08)" horizontal={false} />
        ...
        >
          ...
          {/* Tabs */}
          <div className="flex gap-1 mb-4 bg-[rgb(var(--rule)/0.06)] rounded-lg p-1">
          ...
          <ResponsiveContainer width="100%" height={340}>
            <AreaChart data={learningActivityData} margin={{ top: 10, right: 10, left: -10, bottom: 0 }}>
              ...
              <CartesianGrid strokeDasharray="3 3" stroke="rgb(var(--rule)/0.08)" />
      ...
      <div className="grid grid-cols-[40%_60%] gap-5">
        ...
        <motion.div
          ...
          className="bg-card rounded-2xl p-6 border border-[rgb(var(--rule)/0.08)] flex flex-col items-center"
          style={{ boxShadow: '0 4px 20px rgb(var(--rule)/0.08)' }}
        >
          ...
          <div className="space-y-3">
            {departmentCertificationData.map((dept, i) => (
              ...
              >
                ...
                <div className="h-1 bg-[rgb(var(--rule)/0.08)] rounded-full overflow-hidden">
                  <motion.div
      ...
      <div className="grid grid-cols-2 gap-5">
            ...
            {pipelineData.map((tier, i) => (
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1 h-10 bg-[rgb(var(--rule)/0.06)] rounded-lg overflow-hidden relative">
                    <motion.div
        ...
        >
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead>
                <tr className="border-b border-[rgb(var(--rule)/0.08)]">
              ...
              <tbody>
                {readinessData.map((emp, i) => (
                  <motion.tr
                    ...
                    animate={{ opacity: 1, x: 0 }}
                    transition={{ duration: 0.3, delay: i * 0.05 }}
                    className="border-b border-[rgb(var(--rule)/0.06)] last:border-0"
                  >
                    ...
                    <td className="py-2 px-2">
                      <div className="flex items-center gap-2">
                        <div className="w-12 h-1.5 bg-[rgb(var(--rule)/0.08)] rounded-full overflow-hidden">
                          <motion.div
          ...
          <div className="space-y-4">
            {roiMetrics.map((metric, i) => (
              <motion.div
                ...
                className="bg-[rgb(var(--rule)/0.04)] rounded-xl p-4"
              >
