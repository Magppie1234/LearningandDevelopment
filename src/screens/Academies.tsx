...
export default function Academies() {
  ...
  return (
    <div className="bleed relative min-h-screen">
      ...
      <motion.section
        ...
        className="pb-6 border-b border-[rgb(var(--rule)/0.08)]"
      >
        ...
        <div className="flex flex-wrap items-center gap-4 mt-6">
          <div className="relative w-[360px]">
            ...
            <input
              ...
              className="w-full bg-cream border border-[rgb(var(--rule)/0.12)] rounded-lg pl-10 pr-4 py-2.5 text-sm text-ink-primary placeholder:text-ink-tertiary focus:outline-none focus:border-ink-primary focus:ring-[3px] focus:ring-[rgb(var(--rule)/0.08)] transition-all"
            />
          </div>
          ...
          <div className="relative">
            <select
              ...
              className="appearance-none bg-cream border border-[rgb(var(--rule)/0.12)] rounded-lg pl-4 pr-10 py-2.5 text-sm text-ink-primary focus:outline-none focus:border-ink-primary cursor-pointer"
            >
              {levelFilters.map((f) => (
      ...
      <motion.section
        ...
        className="relative overflow-hidden rounded-3xl bg-card border border-[rgb(var(--rule)/0.08)] shadow-card p-10"
      >
        {/* Decorative pattern */}
        <div
          ...
          <div className="flex flex-wrap gap-3 mb-6">
            {[
              ...
              <motion.div
                ...
                className="flex items-center gap-2 bg-cream border border-[rgb(var(--rule)/0.08)] rounded-full px-4 py-2"
              >
      ...
      <section>
        <div className="flex items-center gap-3 mb-6">
          ...
          <span className="inline-flex items-center justify-center bg-[rgb(var(--rule)/0.06)] text-ink-secondary text-xs font-medium rounded-full px-3 py-1">
            ...
            return (
              <motion.div key={academy.id} variants={itemFadeUp}>
                <Link
                  ...
                  className="group block bg-cream rounded-2xl border border-[rgb(var(--rule)/0.08)] overflow-hidden shadow-card hover:shadow-elevated hover:-translate-y-1 transition-all duration-300"
                >
                  {/* Top color strip */}
                  <div
                  ...
                  <div className="p-5">
                    ...
                    {enrolledCourses > 0 && (
                      <div className="mt-4 pt-4 border-t-[0.5px] border-[rgb(var(--rule)/0.1)] dark:border-[rgba(255,255,255,0.08)]">
                        <AcademyProgressCard
                          variant="inline"
                          title="Your progress"
                          icon={IconComponent}
        ...
        <ScrollArea className="w-full whitespace-nowrap">
          <div className="flex gap-5 pb-2">
            {recentlyAddedCourses.map((course, idx) => (
              ...
              >
                <div className="bg-surface-cream rounded-xl border border-[rgb(var(--rule)/0.08)] overflow-hidden shadow-card hover:shadow-elevated hover:-translate-y-1 transition-all duration-300">
          ...
          {learningPaths.map((path, idx) => {
            ...
            return (
              <motion.div
                ...
                className="bg-cream rounded-2xl border border-[rgb(var(--rule)/0.08)] p-6 shadow-card hover:shadow-elevated hover:-translate-y-0.5 transition-all duration-300"
              >
                      ...
                      <div className="flex flex-col items-center flex-1">
                        <div
                          className={cn(
                            ...
                            stage.status === 'future' &&
                              'bg-transparent border-[rgb(var(--rule)/0.2)]'
                          )}
                        />
                ...
                {/* CTA */}
                <button className="inline-flex items-center gap-1.5 text-sm font-medium text-ink-secondary hover:text-ink-primary hover:bg-[rgb(var(--rule)/0.04)] px-3 py-1.5 rounded-full transition-all">
                  View Path
                  <ArrowRight size={14} />
                </button>
              </motion.div>
