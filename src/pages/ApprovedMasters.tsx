...
function MetaFooter({ meta }: { meta: MasterMeta }) {
  return (
    <div className="mt-3 pt-3 border-t border-[rgba(0,59,70,0.06)] flex flex-wrap gap-x-4 gap-y-1 text-[11px] text-ink-tertiary">
      ...
      <div className="space-y-4">
        {section === 'products' &&
          PRODUCT_MASTER.map((r) => (
            <article key={r.id} className="rounded-2xl bg-white/70 dark:bg-white/5 border border-[rgba(0,59,70,0.08)] p-5">
